...
public class AdminBlogController {
    ...
    public String showActivityCenter(
        ...
        Page<NotificationDTO> notificationPage = notificationService.getNotificationsForUser(email, pageable);
        long unreadCount = notificationService.countUnreadNotifications(email);
